import{_ as n,c as a,o as p,a0 as l}from"./chunks/framework.CAcMrZkh.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"blog/excel-download.md","filePath":"blog/excel-download.md"}'),e={name:"blog/excel-download.md"};function t(c,s,o,i,r,m){return p(),a("div",null,s[0]||(s[0]=[l(`<p><strong>前端Table下载excle</strong></p><p>前端表格 查看源码就是一个 Table</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>   // vue3.5  获取到组件  tableRef?.$el 拿到 HTMLElement</span></span>
